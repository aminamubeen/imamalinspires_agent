...
A fully automated, human-in-the-loop pipeline that wakes up every morning and evening, picks a wisdom quote from Imam Ali (AS), renders beautifully styled images, writes a peaceful caption using Claude AI, and asks for your approval on Telegram before posting a carousel to Instagram — all on a randomised schedule.
